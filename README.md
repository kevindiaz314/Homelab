# Homelab Docker Compose Repository

This repository contains Docker Compose configurations for my homelab services, managed through Dockhand with GitHub integration.
...
- **tududi** - Self-hosted task and project management app.
